...
- Linter versions upgrades
  ...
  - [ansible-lint](https://ansible-lint.readthedocs.io/) from 24.2.1 to **24.2.2** on 2024-04-11
  - [cfn-lint](https://github.com/aws-cloudformation/cfn-lint) from 0.86.1 to **0.86.2** on 2024-04-11
  - [csharpier](https://csharpier.com/) from 0.27.3 to **0.28.0** on 2024-04-11
  - [dotnet-format](https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-format) from 8.0.103 to **8.0.104** on 2024-04-11
  - [protolint](https://github.com/yoheimuta/protolint) from 0.49.3 to **0.49.4** on 2024-04-11
  - [pyright](https://github.com/Microsoft/pyright) from 1.1.357 to **1.1.358** on 2024-04-11
  - [ruff](https://github.com/astral-sh/ruff) from 0.3.5 to **0.3.6** on 2024-04-11
  - [checkov](https://www.checkov.io/) from 3.2.53 to **3.2.60** on 2024-04-11
  - [secretlint](https://github.com/secretlint/secretlint) from 8.1.2 to **8.2.3** on 2024-04-11
  - [trufflehog](https://github.com/trufflesecurity/trufflehog) from 3.72.0 to **3.73.0** on 2024-04-11
  - [rubocop](https://rubocop.org/) from 1.62.1 to **1.63.1** on 2024-04-11
  - [cspell](https://github.com/streetsidesoftware/cspell/tree/master/packages/cspell) from 8.6.1 to **8.7.0** on 2024-04-11
  - [vale](https://vale.sh/) from 3.3.1 to **3.4.0** on 2024-04-11
  - [sqlfluff](https://www.sqlfluff.com/) from 3.0.3 to **3.0.4** on 2024-04-11
  - [terragrunt](https://terragrunt.gruntwork.io) from 0.55.20 to **0.56.2** on 2024-04-11
<!-- linter-versions-end -->
